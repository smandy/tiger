...
static this() {
  ...
  version (Posix) {
    version (OSX) {
      possibleFileNames ~= ["libcomplexmodule_wrap.dylib", "libcomplexmodule_wrap.bundle"];
    }
    possibleFileNames ~= ["libcomplexmodule_wrap.so"];
  } else version (Windows) {
    possibleFileNames ~= ["complexmodule_wrap.dll", "libcomplexmodule_wrap.so"];
  } else {
  ...
  mixin(bindCode("swigRegisterExceptionCallbackscomplexmodule", "SWIGRegisterExceptionCallbacks_complexmodule"));
  //#endif // SWIG_D_NO_EXCEPTION_HELPER
  //#if !defined(SWIG_D_NO_STRING_HELPER)
  mixin(bindCode("swigRegisterStringCallbackcomplexmodule", "SWIGRegisterStringCallback_complexmodule"));
  //#endif // SWIG_D_NO_STRING_HELPER
  
  mixin(bindCode("Complex_x_set", "D_Complex_x_set"));
  mixin(bindCode("Complex_x_get", "D_Complex_x_get"));
  mixin(bindCode("Complex_y_set", "D_Complex_y_set"));
  mixin(bindCode("Complex_y_get", "D_Complex_y_get"));
  mixin(bindCode("Complex_getX", "D_Complex_getX"));
  mixin(bindCode("Complex_getY", "D_Complex_getY"));
  mixin(bindCode("new_Complex__SWIG_0", "D_new_Complex__SWIG_0"));
  mixin(bindCode("new_Complex__SWIG_1", "D_new_Complex__SWIG_1"));
  mixin(bindCode("new_Complex__SWIG_2", "D_new_Complex__SWIG_2"));
  mixin(bindCode("Complex_opAdd", "D_Complex_opAdd"));
  mixin(bindCode("Complex_opSub", "D_Complex_opSub"));
  mixin(bindCode("Complex_toString", "D_Complex_toString"));
  mixin(bindCode("Complex___repr__", "D_Complex___repr__"));
  mixin(bindCode("delete_Complex", "D_delete_Complex"));
}
...
extern(C) void function(
  ...
  SwigExceptionCallback noSuchElementCallback) swigRegisterExceptionCallbackscomplexmodule;
//#endif // SWIG_D_NO_EXCEPTION_HELPER

//#if !defined(SWIG_D_NO_STRING_HELPER)
extern(C) void function(SwigStringCallback callback) swigRegisterStringCallbackcomplexmodule;
//#endif // SWIG_D_NO_STRING_HELPER
...
private class SwigExceptionHelper {
  static this() {
    swigRegisterExceptionCallbackscomplexmodule(
      &setException,
...
private class SwigStringHelper {
  static this() {
    swigRegisterStringCallbackcomplexmodule(&createString);
  }
...
SwigExternC!(void function(void* jarg1, int jarg2)) Complex_x_set;
SwigExternC!(int function(void* jarg1)) Complex_x_get;
SwigExternC!(void function(void* jarg1, int jarg2)) Complex_y_set;
SwigExternC!(int function(void* jarg1)) Complex_y_get;
SwigExternC!(int function(void* jarg1)) Complex_getX;
SwigExternC!(int function(void* jarg1)) Complex_getY;
SwigExternC!(void* function(int jarg1, int jarg2)) new_Complex__SWIG_0;
SwigExternC!(void* function(int jarg1)) new_Complex__SWIG_1;
SwigExternC!(void* function()) new_Complex__SWIG_2;
SwigExternC!(void* function(void* jarg1, void* jarg2)) Complex_opAdd;
SwigExternC!(void* function(void* jarg1, void* jarg2)) Complex_opSub;
SwigExternC!(char* function(void* jarg1)) Complex_toString;
SwigExternC!(char* function(void* jarg1)) Complex___repr__;
SwigExternC!(void function(void* jarg1)) delete_Complex;
