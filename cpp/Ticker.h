...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &argo::TickListenerPrx::_iceI_onTick, t, context);
    }
    ...
    onImageAsync(const TickImage& img,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &argo::TickListenerPrx::_iceI_onImage, img, context);
    }
...
public:
    ...
    subscribeAsync(const ::std::shared_ptr<TickListenerPrx>& l,
                   ...
                   const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &argo::TickerPlantPrx::_iceI_subscribe, l, context);
    }
    ...
    subscribeWithIdentAsync(const ::Ice::Identity& ident,
                            ...
                            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &argo::TickerPlantPrx::_iceI_subscribeWithIdent, ident, context);
    }
...
class TickListener;
/// \cond INTERNAL
void _readProxy(::Ice::InputStream*, ::IceInternal::ProxyHandle< TickListener>&);
::IceProxy::Ice::Object* upCast(TickListener*);
/// \endcond

class TickerPlant;
/// \cond INTERNAL
void _readProxy(::Ice::InputStream*, ::IceInternal::ProxyHandle< TickerPlant>&);
::IceProxy::Ice::Object* upCast(TickerPlant*);
/// \endcond
...
typedef ::std::vector<Tick> TickSeq;

typedef ::std::vector<TickSeq> TickImage;
